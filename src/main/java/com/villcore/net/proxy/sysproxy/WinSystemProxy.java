package com.villcore.net.proxy.sysproxy;
...
public class WinSystemProxy {
    private static final Logger LOG = LoggerFactory.getLogger(WinSystemProxy.class);
    ...
    public WinSystemProxy(String exeRootPath) {
        ...
        LOG.info("sysproxy.exe path = [{}]", sysproxyFile.getAbsolutePath());
    }
    ...
    public void setGlobalProxy(String proxyUrl) throws IOException {
        String commond = sysproxyFile.getAbsolutePath();
        LOG.info("set global proxy -> [{}]", proxyUrl);
