...
import com.villcore.net.proxy.v2.client.ByteBufPackgeHandler;
import com.villcore.net.proxy.v2.client.ConnectionManager;
import com.villcore.net.proxy.v2.client.PackageGatherHandler;
...
public class ChildHandlerInitlizer extends ChannelInitializer<SocketChannel> {
    ...
    private com.villcore.net.proxy.v2.client.PackageQeueu pkgQueue;
